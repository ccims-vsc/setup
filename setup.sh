...
rm -rf ccims-vsc
mkdir ccims-vsc
docker run -it -v "$(pwd):/home/ccims" -w /home/ccims/ccims-vsc --entrypoint="" node:latest /bin/bash -c "git clone  --single-branch --branch gropiusify https://github.com/ccims-vsc/ccims-vsc-setup.git && chmod +x ./ccims-vsc-setup/setup.sh && ./ccims-vsc-setup/setup.sh"
